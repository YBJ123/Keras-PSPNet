...
# 训练集占总数据集的80%
num_train_samples = 11754 
# 验证集占总数据集的20%         
num_valid_samples = 2939           
batch_size = 4
epochs = 100
patience = 10
...
rgb_image_path = "../SemanticHumanMatting/data_shm_person/Training_set/composite"
# train mask path
#mask_img_path = '/home/datalab/ex_disk1/bulang/segmentation_data_repository/原始数据/T-Net-Person/mask'
mask_img_path = "../SemanticHumanMatting/data_shm_person/Training_set/alpha"
